...
public class WeirdList {
    ...
    public static final WeirdList EMPTY = new EmptyWierdList(0, null);
    ...
    public String toString() {
        String strTail = this.tail.toString();
        return " " + this.head + strTail; // REPLACE THIS LINE WITH THE RIGHT ANSWER.
    }
    ...
    public WeirdList map(IntUnaryFunction func) {
        ...
        WeirdList newList = this.tail.map(func);
        return new WeirdList(newHead, newList);  // REPLACE THIS LINE WITH THE RIGHT ANSWER.
    }
